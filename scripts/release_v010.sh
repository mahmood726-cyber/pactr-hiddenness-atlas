...
echo ""
echo "  Update memory file:"
echo "    C:/Users/user/.claude/projects/C--Users-user/memory/pactr-hiddenness-atlas.md"
echo "    Bump status to 'v0.1.0 shipped'; record headline percentage;"
echo "    record TrialScout sanity outcome."
echo ""
